Full credit to s60sc and the contributors below on GitHub for the code and README. I take resposiblity to for researching this application, including understadning how to set it up,
its functionaly, and how it operates and implementing this into the greater design of our project. I also streamlined this application for our project as much as possible
by deleting unneccacry files and attempting to remove blocks of code, as well as changing configuration settings to mathc our goals for the project, like removing external IP
functionality for security reasons.

Original GitHub repo: https://github.com/s60sc/ESP32-CAM_MJPEG2SD
